...
export function mapProfileRow(row: any): UserProfile {
  ...
  return {
    ...
    height: row.height || row.height_inches || '',
    ...
    drinkingFrequency: row.drinking_frequency || row.lifestyle?.drinking || '',
    cannabisFrequency: row.cannabis_frequency || row.lifestyle?.weed || row.lifestyle?.cannabis || '',
    tobaccoFrequency: row.tobacco_frequency || row.lifestyle?.tobacco || '',
    otherDrugsFrequency: row.other_drugs_frequency || row.lifestyle?.drugs || row.lifestyle?.otherDrugs || '',
    partnerLifestylePreferences: row.partner_lifestyle_preferences || row.partnerLifestylePreferences || undefined,
