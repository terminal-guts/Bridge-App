    ...
    <StyledView className="mb-4">
      <StyledView className="flex-row items-start mb-2">
        <StyledView className="w-5 h-5 bg-primary-100 rounded-full items-center justify-center mr-2 mt-0.5">
          <EvaIcon name="question-mark-circle" variant="outline" size={14} color="#437FFF" />
        </StyledView>
      ...
      <StyledScrollView className="flex-1">
        <StyledView className="px-4 py-4">
            ...
            <StyledView className="space-y-3">
              <StyledView className="flex-row items-start">
                <StyledView className="w-10 h-10 bg-success/10 rounded-lg items-center justify-center mr-3">
                  <EvaIcon name="question-mark-circle" variant="outline" size={20} color="#12B981" />
                </StyledView>
              ...
              <StyledView className="flex-row items-start">
                <StyledView className="w-10 h-10 bg-error/10 rounded-lg items-center justify-center mr-3">
                  <EvaIcon name="alert-circle" variant="outline" size={20} color="#EF4444" />
                </StyledView>
                <StyledView className="flex-1">
              ...
              >
                <StyledView className="w-10 h-10 bg-warning/10 rounded-lg items-center justify-center mr-3">
                  <EvaIcon name="flag" variant="outline" size={20} color="#F59E0B" />
                </StyledView>
                <StyledView className="flex-1">
                ...
                <EvaIcon name="arrow-ios-forward" variant="outline" size={16} color="#98A2B3" style={{ marginTop: 4 }} />
              </StyledTouchableOpacity>

              <StyledView className="flex-row items-start">
                <StyledView className="w-10 h-10 bg-primary-100 rounded-lg items-center justify-center mr-3">
                  <EvaIcon name="message-circle" variant="outline" size={20} color="#437FFF" />
                </StyledView>
                <StyledView className="flex-1">
          ...
          <Card className="bg-primary-50 border border-primary-100">
            <StyledView className="flex-row items-start">
              <EvaIcon name="clock" variant="outline" size={20} color="#437FFF" />
