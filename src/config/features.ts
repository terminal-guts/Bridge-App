...
export const FEATURES: FeatureFlags = {
  // Development Helpers - FRONTEND MOCK MODE
  DEVELOPMENT_AUTO_FILL_ONBOARDING: true, // ✅ SHOW MOCK PROFILE - FRONTEND ONLY MODE
  DEVELOPMENT_CREATE_MOCK_DATA: true, // ✅ CREATE MOCK DATA - FRONTEND ONLY MODE
  DEVELOPMENT_FORCE_FRESH_SESSION: false, // ❌ DISABLED - Annoying for testing
  ENABLE_DEVELOPER_MENU: true, // ✅ DEVELOPER MENU ENABLED
  DEVELOPMENT_SKIP_AUTH: false, // ❌ KEEP AUTH FLOW FOR REALISTIC TESTING
  DEV_USER_ID: null, // Use default dev user
  DEVELOPMENT_UNLOCK_FRIENDS_AREA: true, // ✅ UNLOCK FRIENDS AREA

  // Backend Integration
  COMMUNITY_BACKEND_ENABLED: true, // ✅ REAL BACKEND - SUPABASE DIRECT CALLS
